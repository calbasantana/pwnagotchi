![Image_1](https://github.com/user-attachments/assets/686558df-1442-4529-a1ca-2db998648016)
# Introduction
...
![Image_6](https://github.com/user-attachments/assets/8a80b2ff-634f-4700-b802-e6ae8bfb268b)

9. The default user is admin and the default password is admin. The next screen should be the GUI for the Pwnagotchi.
![Image_7](https://github.com/user-attachments/assets/0a2698d5-500b-40c7-aaaf-50c36c118304)

10. From here, you can make any edits you want. I highly recommend putting it in auto mode. It will, over the next few minutes running, run it in AI mode, which optimizes for efficiency in pwning.
![Image_8](https://github.com/user-attachments/assets/6a7e773c-036e-41ae-ad87-e4a7a23f3eb7)

# Final Assembly
Now, disconnect the initial assembly block from your PC and press the button above the magnet behind the battery to boot up the battery. Insert the battery into the 3D printed case and screw in the cover. You should have a fully, ready-to-pwn, Pwnagotchi!
